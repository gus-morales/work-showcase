...
- Reference: 9.37%
- Monitored: 9.88%
(Computed separately from PSI, which only covers observed values.)
...
- Gap: 3.56%. The model under-predicts risk once the shock hits, even though PSI is clean. This is concept drift, not covariate drift. Outcome-rate monitoring catches it; PSI alone does not.
